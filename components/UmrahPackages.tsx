...
export default function UmrahPackages() {
  ...
  return (
    <section ref={ref} className="py-24 md:py-32 px-6 bg-[var(--surface)]" id="umrah">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-[var(--muted)] mb-6">
            Custom packages available — Contact us for group rates
          </p>
          <motion.a
            href="https://wa.me/918919990806"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] text-white font-['Cinzel'] text-sm tracking-wider rounded-full"
