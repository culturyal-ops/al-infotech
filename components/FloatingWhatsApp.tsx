...
export default function FloatingWhatsApp() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setIsVisible(true);
      // Show tooltip for 3 seconds on first appearance
      setShowTooltip(true);
          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 20 }}
                className="absolute bottom-full right-0 mb-3 bg-white rounded-lg shadow-card-hover p-3 pr-8 whitespace-nowrap"
              >
                <button
