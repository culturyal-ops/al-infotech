...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0A1810] border-t border-white/10">
      <div className="container-custom py-16 md:py-20">
        <div className="grid md:grid-cols-3 gap-12 md:gap-16 mb-16">
          ...
          >
            <h3 className="font-playfair text-3xl md:text-4xl font-bold text-gold mb-2">
              AL-INFOTECH
            </h3>
            <p className="text-gold/60 text-sm tracking-[0.2em] uppercase mb-8">
              Tours and Travels
            </p>
            <p className="text-white/50 text-sm mb-8 border-l-2 border-gold/30 pl-4">
          ...
          >
            <h4 className="text-gold text-sm tracking-[0.2em] uppercase mb-6">Quick Links</h4>
          ...
          >
            <h4 className="text-gold text-sm tracking-[0.2em] uppercase mb-6">Get in Touch</h4>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-white/30 hover:text-gold transition-colors text-xs flex items-center gap-2 group"
          >
            <span>Powered by</span>
            <span className="px-3 py-1 border border-gold/30 group-hover:border-gold text-gold text-xs tracking-wider">
              RevolQ
            </span>
          </a>
        </div>
